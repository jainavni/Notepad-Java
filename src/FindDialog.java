...
///////////////////////
    ...
    public FindDialog(TextArea jta) {
...
/////////////////////////
    ...
    int findNext() {
        ...
        if (up.isSelected()) {
            ...
            /**
             * ***NotePad doesn't use the else part, but it should be, instead of
             * using caretPosition.**/
            else lastIndex=lastIndex-s2.length();
  ...
  )
{
     int selStart = jta.getSelectionStart();
        int selEnd = jta.getSelectionEnd();
	jta.replaceRange(replaceWith.getText(),selStart,selEnd);}
